...
function(qt_android_build_apk)
    ...
    if(NOT APK_QML_ROOT_PATH)
		...
		# XXX: ( cd /home/user/Android/Sdk/ndk/21.0.6113669/toolchains/ ; ln -s llvm llvm-4.9 ) -> /home/user/Android/Sdk/ndk/21.0.6113669/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip -> /home/user/Android/Sdk/ndk/21.0.6113669/toolchains/llvm-4.9/prebuilt/linux-x86_64/bin/llvm-strip
        ...
        COMMAND ${CMAKE_COMMAND} -E copy
            ...
            ${APK_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI}
				COMMAND ${CMAKE_COMMAND} -E copy 
						...
						${APK_DIR}/libs/${CMAKE_ANDROID_ARCH_ABI}/libvotecnode-android.so

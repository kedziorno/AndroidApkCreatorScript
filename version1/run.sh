...
CLANG_NDK=${NDK}/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android29-clang++
LLD=${NDK}/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android-ld
...
${LLD} -v -o "${ApkDir}/libnative-activity.so" ${x86LinkerFlags} ${x86CommonFlags} ${LinkerFlags}
